...
namespace AutocompleteMenuNS
{
    ...
    public class TextBoxWrapper : ITextBoxWrapper
    {
        ...
        private PropertyInfo selectedText2;
        ...
        protected virtual void Init()
        {
            ...
            selectedText2 = t.GetProperty("SelectedText");
            ...
            else if (target is RichTextBox2)
                (target as RichTextBox2).VScroll += new EventHandler(TextBoxWrapper_VScroll);
        }
        ...
        public static TextBoxWrapper Create(Control targetControl)
        {
            ...
            if (result.selectedText2 == null || result.selectionLength == null || result.selectionStart == null ||
        ...
        {
            get { return (string) selectedText2.GetValue(target, null); }
            set { selectedText2.SetValue(target, value, null); }
        }
        public virtual string SelectedText2
        {
            get { return (string)selectedText2.GetValue(target, null); }
            set { selectedText2.SetValue(target, value, null); }
        }
